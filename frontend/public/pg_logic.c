...
int main(){addPG(1,"Green View PG","College Road",6500,3,1,.7,"Near Main Gate");addPG(2,"Student Square","University Chowk",5500,2,2,1.2,"Opposite City Library");addPG(3,"Maple Residency","Shivaji Nagar",8500,2,1,2.1,"Shivaji Nagar Bus Stop");addPG(4,"Campus Corner","College Road",4800,3,1,.9,"Near College Road");printf("CampusNest DSA Prototype\n");listAvailable();linearSearch("College");sortByRent();return 0;}
